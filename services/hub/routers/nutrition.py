"""
Nutrition Tracker Router — personal calorie & macro tracker.
...
# === Init / Cleanup Functions (called by main app) ============================

async def init_db():
    """Initialize nutrition database tables and seed data. Call from main app startup."""
...
@router.post("/api/log/quick", status_code=201)
...
@router.delete("/api/log/{entry_id}")
