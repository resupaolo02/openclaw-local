"""
Finance Tracker Service — personal expense & income tracker with credit card tracking.
...
async def index():
    ...
    return HTMLResponse("<h1>Finance Tracker not found</h1>")
...
@app.post("/api/account-records", status_code=201)
...
@app.put("/api/account-records/{account_id}")
...
@app.put("/api/account-records/{account_id}/balance")
...
@app.delete("/api/account-records/{account_id}")
...
@app.get("/api/credit-cards/summary")
...
@app.get("/api/credit-cards/transactions")
...
@app.post("/api/credit-cards/mark-paid")
...
@app.get("/api/credit-cards/cards")
...
@app.get("/api/credit-cards/monthly-trend")
