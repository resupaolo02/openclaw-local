"""
Core API — Internal shared service for OpenClaw microservices.
Provides Docker operations, session management, skills, and LLM health.
"""
...
@app.get("/skill/{skill_name}/content")
